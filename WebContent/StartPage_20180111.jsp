...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="StartPage_20180111.jsp" class="w3-bar-item w3-button w3-padding-large w3-white">홈</a>
    <a href="LoginForm.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">로그인</a>
    <a href="SignUpForm.jsp" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">회원가입</a>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <h1 class="w3-margin w3-jumbo">fuck you!!!</h1>
